...
@javaClass{smt.SatProp}
@reflect{Uses URI Resolver Registry}
public java void buildTheory(Formula f);


@javaClass{smt.SatProp}
@reflect{Uses URI Resolver Registry}
public java list[map[str, str]] findModel(map[str, str] assumpts, int maxSol);

@javaClass{smt.SatProp}
@reflect{Uses URI Resolver Registry}
public java list[map[str, str]] findModel(int maxSol);
